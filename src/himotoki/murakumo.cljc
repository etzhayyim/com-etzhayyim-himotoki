...
(defn collection
  [name]
  (str "com.etzhayyim.himotoki." name))
...
(def cell-specs {
  ...
  :request_intake {:legacy-cell "request-intake"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "request_intake")]
     :required-gates common-gates
     :trigger "manifest cell request_intake"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :compose {:legacy-cell "compose"
     ...
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :dispatch {:legacy-cell "dispatch"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "dispatch")]
     :required-gates common-gates
     :trigger "manifest cell dispatch"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :deadline_tracker {:legacy-cell "deadline-tracker"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "deadline_tracker")]
     :required-gates common-gates
     :trigger "manifest cell deadline_tracker"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :response_intake {:legacy-cell "response-intake"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "response_intake")]
     :required-gates common-gates
     :trigger "manifest cell response_intake"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
  :appeal_route {:legacy-cell "appeal-route"
     :phase :event
     :murakumo-node "reuben"
     :collections [(collection "appeal_route")]
     :required-gates common-gates
     :trigger "manifest cell appeal_route"
     :ceiling "Manifest-driven migration scaffold; explicit execution stays in runtime methods"}
})
